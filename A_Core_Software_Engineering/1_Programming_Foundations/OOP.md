...
- Speculatively General (Dự đoán chung)
  - Trong đoạn code ví dụ mà tác giả đã đưa ra, có thể doán được là tác giả có ý định là trao đổi tính dễ đọc của đoạn code để đổi lấy tính dễ thay đổi. Nghĩa là tradeoff giữ 'Hơi phức tạp một chút nhưng đổi lại sẽ dể thay đổi code trong tương lai'
